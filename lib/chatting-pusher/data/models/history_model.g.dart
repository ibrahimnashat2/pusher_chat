...
HistoryModel _historyModelDeserialize(
  ...
  final object = HistoryModel(
    id: id,
    roomId: reader.readString(offsets[0]),
...
extension HistoryModelQueryFilter
  ...
  QueryBuilder<HistoryModel, HistoryModel, QAfterFilterCondition> roomIdEqualTo(
    String value, {
  ...
  QueryBuilder<HistoryModel, HistoryModel, QAfterFilterCondition> roomIdBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<HistoryModel, HistoryModel, QAfterFilterCondition> roomIdMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension HistoryModelQuerySortBy
  ...
  QueryBuilder<HistoryModel, HistoryModel, QAfterSortBy> sortByRoomId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'roomId', Sort.asc);
    });
  }

  QueryBuilder<HistoryModel, HistoryModel, QAfterSortBy> sortByRoomIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension HistoryModelQuerySortThenBy
  ...
  QueryBuilder<HistoryModel, HistoryModel, QAfterSortBy> thenByRoomId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'roomId', Sort.asc);
    });
  }

  QueryBuilder<HistoryModel, HistoryModel, QAfterSortBy> thenByRoomIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'roomId', Sort.desc);
    });
  }
...
extension HistoryModelQueryWhereDistinct
  ...
  QueryBuilder<HistoryModel, HistoryModel, QDistinct> distinctByRoomId(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension HistoryModelQueryProperty
  ...
  QueryBuilder<HistoryModel, String, QQueryOperations> roomIdProperty() {
    return QueryBuilder.apply(this, (query) {
